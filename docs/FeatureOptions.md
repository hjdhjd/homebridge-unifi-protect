...
| `Enable.Video.TranscodeUseHwAcceleration`            | Use hardware transcoding if available. <BR>**This option can be further customized on a per-streaming-client basis.**</BR><BR>**Note: this option won't have an effect on all platforms.**</BR>
