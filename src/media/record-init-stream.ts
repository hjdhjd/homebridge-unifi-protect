...
// aborts before the init arrives - whether triggered by a HAP-initiated close or a thin discontinuity restart - so we catch that rejection and return, ending the
// for-await cleanly and leaving the post-loop teardown to decide on its own end-of-stream marker.
