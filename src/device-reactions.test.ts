 ...
 * reconcile decision lives in types.ts (a poison-free, device-classification home reachable from a test); the sensor tamper-state mapping lives in sensor.ts (which
...
import { doorbellReconcileAction } from "./types.ts";
