 ...
 * the production buildAdvertisedProfiles / buildAdvertisedResolutions output asserted against the oracle-derived, hand-verified golden-master in resolution.fixtures.ts,
...
import { AI_PRO_CHANNELS, C5_WITNESS_CHANNELS, CAMERA_FIXTURES, FIXTURE_HOST, FIXTURE_RTSPS_PORT, MIXED_RTSP_DISABLED_CHANNELS, PACKAGE_FIXTURES, SANITY_FAIL_CHANNELS,
  makeChannel } from "./resolution.fixtures.ts";
import { buildAdvertisedProfiles, buildAdvertisedResolutions, buildChannelProfile, capByPixels, isPrimaryChannel, selectChannelProfile } from "./devices/resolution.ts";
...
import type { SelectRequest } from "./devices/resolution.ts";
