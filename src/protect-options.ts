...
export const featureOptions: { [index: string]: ProtectFeatureOption[] } = {
  ...
  "Device": [
    ...
    { default: false, description: "Add a switch accessory to control PTZ camera to move preset home", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.-1" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 1", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.0" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 2", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.1" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 3", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.2" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 4", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.3" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 5", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.4" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 6", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.5" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 7", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.6" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 8", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.7" },
    { default: false, description: "Add a switch accessory to control PTZ camera to move to preset 9", hasCameraFeature: [ "isPtz" ], name: "Ptz.Preset.Switch.8" }
  ],
